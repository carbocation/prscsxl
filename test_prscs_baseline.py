...
class CommandLineCharacterizationTests(unittest.TestCase):
    def test_existing_options_and_defaults_are_preserved(self):
        ...
        self.assertEqual(parameters['project_sumstats'], 'FALSE')
        self.assertEqual(parameters['projection_fraction'], 0.2)
        self.assertEqual(parameters['projection_min_eigenvalue'], 0.01)
